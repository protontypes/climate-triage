...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center space-y-10 bg-stone-50 text-center text-gray-900 antialiased dark:bg-black-400 dark:text-silver-500">
